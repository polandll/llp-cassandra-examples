# DROP ROLE {#cqlDropRole .reference}

Removes a role.

Removes an existing role. In Cassandra 2.2 and later, you can test that the role exists. Enclose role names with special characters and capitalization in single quotation marks.
