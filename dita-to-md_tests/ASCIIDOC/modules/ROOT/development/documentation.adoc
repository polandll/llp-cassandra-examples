...
image:images/docs_fork.png[image]
...
image:images/docs_create_branch.png[image]
...
image:images/docs_create_file.png[image]
...
image:images/docs_editor.png[image]

Make sure to preview added content before committing any changes.

image:images/docs_preview.png[image]
