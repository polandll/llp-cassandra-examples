...
|Ratio |C* Version
|https://lz4.github.io/lz4/[LZ4] |`LZ4Compressor` a|
____
A+
____
...
|https://lz4.github.io/lz4/[LZ4HC] |`LZ4Compressor` a|
____
C+
____
...
|https://facebook.github.io/zstd/[Zstd] |`ZstdCompressor` a|
____
A-
____
...
|http://google.github.io/snappy/[Snappy] |`SnappyCompressor` a|
____
A-
____
...
|https://zlib.net[Deflate (zlib)] |`DeflateCompressor` a|
____
C
____
